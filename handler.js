...
// ── Modo Mantenimiento ──
if (settings.mantenimiento && !isVotOwn) {
  return msg.reply(global.mess.mantenimiento)
}
...
try {
  ...
  settings.commandStats = settings.commandStats || {}
  settings.commandStats[command] = (settings.commandStats[command] || 0) + 1
  ...
  await db.updateSettings(botJid, 'commandStats', settings.commandStats)
