...
export const defSets = {
  ...
  type: 'Sub',
  link: '',
  banner: 'https://files.catbox.moe/5qa9qf.mp4', // puedes cambiarlo a un .mp4 si quieres video
  icon: 'https://files.catbox.moe/ypxvyv.jpg',
  currency: 'Kon',
  namebot: 'あ ┊⏤͟͟͞͞☆ Rimuru Tenpest ϟ', // nombre completo del bot
  namebot2: 'Rimuru', // nombre corto
  owner: 'kiri-M', // tu nombre como dueño
  mantenimiento: 0
};
