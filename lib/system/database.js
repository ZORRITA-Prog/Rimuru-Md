...
export const defSets = {
  ...
  commandStats: {},
  type: 'Sub',
  link: 'https://whatsapp.com/channel/0029Vb8B9Q8KbYMQDFDXoO1W',
  banner: 'https://files.catbox.moe/1uliz7.mp4', // puedes cambiarlo a un .mp4 si quieres video
  icon: 'https://files.catbox.moe/h7rc6o.jpeg',
  currency: 'Kon',
  namebot: 'あ ┊⏤͟͟͞͞☆ Sosuke Aizen ϟ', // nombre completo del bot
  namebot2: 'Aizen', // nombre corto
  owner: 'ABRAHAN-M', // tu nombre como dueño
  mantenimiento: 0
};
