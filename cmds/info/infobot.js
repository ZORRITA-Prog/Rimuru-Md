...
export default {
  ...
  run: async ({ msg, sock }) => {
    ...
    const botname = botSettings.namebot || 'Sosuke'
    const botname2 = botSettings.namebot2 || 'Aizen'
